...
var MAP = [
  ...
  // ── OUR WORK ──
  ['work-label','OUR WORK','NUESTRO TRABAJO'],
  ['work-h2','Real projects.<br>Real results.','Proyectos reales.<br>Resultados reales.','html'],
  ['work-sub',"We don't just talk about what we can build — here's proof.",'No solo hablamos de lo que podemos construir — aquí está la prueba.'],
  ['work-tag1','App Development','Desarrollo de Apps'],
  ['work-tag2','SaaS','SaaS'],
  ['work-tag3','Sports','Deportes'],
  ['work-live','LIVE','EN VIVO'],
  ['work-desc','All-in-one sports club management platform for paddle, pickleball and tennis clubs. Real-time reservations, payments, memberships, tournaments — all in one place.','Plataforma todo-en-uno para gestión de clubes deportivos de pádel, pickleball y tenis. Reservas en tiempo real, pagos, membresías y torneos — en un solo lugar.'],
  ['wf1','⚡ Real-time reservations','⚡ Reservas en tiempo real'],
  ['wf2','💳 Multi-method payments','💳 Pagos múltiples métodos'],
  ['wf3','🏆 Tournament management','🏆 Gestión de torneos'],
  ['wf4','💬 WhatsApp automation','💬 Automatización WhatsApp'],
  ['wf5','📊 Analytics dashboard','📊 Panel de analíticas'],
  ['wf6','🔑 QR access control','🔑 Control de acceso QR'],
  ['work-cta','View live project →','Ver proyecto en vivo →'],
  ['work-preview-badge','Sports SaaS','SaaS Deportivo'],
  ['wps1','Reservations','Reservas'],
  ['wps2','Payments','Pagos'],
  ['wps3','Languages','Idiomas'],
  ['wps4','Clubs','Clubes'],
  ['work-coming','More projects coming soon','Más proyectos próximamente'],
